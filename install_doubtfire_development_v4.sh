...
# ============================================================
#  DOUBTFIRE DEVELOPMENT ENVIRONMENT INSTALLER v4 (Ubuntu)
#  Stable MariaDB 10.6 + Fixed Healthchecks
# ============================================================

echo "============================================================"
echo "         DOUBTFIRE DEVELOPMENT INSTALLER v4"
echo "============================================================"
echo ""

if [[ $EUID -ne 0 ]]; then
  echo "❌ Please run this with sudo:"
  echo "   sudo ./install_doubtfire_development_v4.sh"
  exit 1
fi
...
echo "🗑️ Removing API & Web submodules..."
...
echo "✔ Repo replacement complete."
echo ""

# ------------------------------------------------------------
# Write updated docker-compose.yml (MariaDB 10.6 + fixed healthcheck)
# ------------------------------------------------------------
echo "🛠 Building updated docker-compose.yml..."
...
for i in {1..30}; do
  if docker compose exec dev-db mysql -udfire -ppwd -e "SELECT 1" >/dev/null 2>&1; then
...
echo ""
echo "============================================================"
echo " 🎉 DOUBTFIRE DEVELOPMENT ENVIRONMENT IS READY (v4) 🎉"
echo "============================================================"
...
echo ""
echo "⚠ Re-login to apply Docker group membership for your user."
echo "============================================================"
